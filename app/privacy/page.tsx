        ...
        <section className="container mx-auto px-4 pt-12 sm:px-6 md:pt-16 lg:pt-20">
          <div className="mx-auto max-w-4xl">
            <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none text-neutral-800">
              ...
              <div className="space-y-4 text-sm leading-relaxed sm:text-base mb-10 lg:mb-12">
                <p>
              ...
              <div className="mb-10 lg:mb-12">
                ...
                <div className="space-y-4 text-sm leading-relaxed sm:text-base">
                  <h3 className="text-xl font-semibold text-[#1E1A4B]">Interpretation</h3>
                  <p>
                    The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                  </p>

                  <h3 className="text-xl font-semibold text-[#1E1A4B] pt-4">Definitions</h3>
                  ...
                  <ul className="list-disc pl-6 space-y-3">
                    ...
                    <li>
                      <strong>Application</strong> refers to Waygibb, the software program provided by the Company.
                    </li>
                    <li>
                      <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Waygibb.
                    </li>
                    <li>
              ...
              <div className="mb-10 lg:mb-12">
                ...
                <div className="space-y-4 text-sm leading-relaxed sm:text-base">
                  <h3 className="text-xl font-semibold text-[#1E1A4B]">Types of Data Collected</h3>

                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-2">Personal Data</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-4">Usage Data</h4>
                  ...
                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-4">Information Collected while Using the Application</h4>
                  <p>
              ...
              <div className="mb-10 lg:mb-12">
                ...
                <div className="space-y-4 text-sm leading-relaxed sm:text-base">
                  ...
                  <p className="pt-4">We may share Your Personal Data in the following situations:</p>
                  <ul className="list-disc pl-6 space-y-3">
                    <li>
              ...
              <div className="mb-10 lg:mb-12">
                ...
                <div className="space-y-4 text-sm leading-relaxed sm:text-base">
                  ...
                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-2">Account Information</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                  ...
                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-2">Customer Support Data</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                  ...
                  <h4 className="text-lg font-semibold text-[#1E1A4B] pt-2">Usage Data</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Application usage statistics:</strong> up to 24 months to understand feature adoption and service improvements.
                    </li>
                    <li>
                  ...
                  <p className="pt-2">We may retain Personal Data beyond the periods stated above for different reasons:</p>
                  <ul className="list-disc pl-6 space-y-2">
                  ...
                  <p className="pt-2">When retention periods expire, We securely delete or anonymize Personal Data according to the following procedures:</p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
              ...
              <div className="mb-10 lg:mb-12">
                ...
                <div className="space-y-4 text-sm leading-relaxed sm:text-base">
                  <h3 className="text-xl font-semibold text-[#1E1A4B]">Business Transactions</h3>
                  <p>
                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                  </p>

                  <h3 className="text-xl font-semibold text-[#1E1A4B] pt-4">Law enforcement</h3>
                  <p>
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                  </p>

                  <h3 className="text-xl font-semibold text-[#1E1A4B] pt-4">Other legal requirements</h3>
              ...
              <div className="rounded-xl border-l-4 border-[#3b1578] bg-neutral-50 px-6 py-5 sm:px-8 sm:py-6">
                ...
                <div className="text-sm leading-relaxed text-neutral-600 space-y-2">
                  <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li>By email: <a href="mailto:helpdesk@waygibb.com.ng" className="text-[#3b1578] underline">helpdesk@waygibb.com.ng</a></li>
                    <li>By visiting this page on our website: <a href="https://waygibb.com.ng" className="text-[#3b1578] underline">waygibb.com.ng</a></li>
                  </ul>
                </div>
              </div>
