    ...
    <header className="bg-white border-b border-zinc-100 sticky top-0 z-50 py-2 shadow-sm">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {/* WhatsApp Button */}
          <Link href="https://wa.me/2348123938320" target="_blank" rel="noopener noreferrer">
            <button className="bg-white border-2 border-[#1E1A4B] flex items-center justify-center gap-2 text-[#1E1A4B] px-4 py-1.5 sm:px-6 sm:py-2 rounded-full font-bold text-xs sm:text-sm transition-all hover:bg-zinc-50 active:scale-95 shadow-sm">
      ...
      >
        ...
        <div className="mt-auto border-t border-zinc-100 px-5 py-5">
          <Link href="https://wa.me/2348123938320" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)} className="block w-full">
            <button
              className="w-full flex items-center justify-center gap-2 bg-white border-2 border-[#1E1A4B] text-[#1E1A4B] py-2.5 rounded-full font-bold text-sm transition-all hover:bg-zinc-50 active:scale-95 shadow-sm"
            >
