    ...
    <header className="bg-white border-b border-zinc-100 sticky top-0 z-50 py-2 shadow-sm">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {/* WhatsApp Button */}
          <Link href="https://wa.me/2347048058738" target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        <div className="mt-auto border-t border-zinc-100 px-5 py-5">
          <Link href="https://wa.me/2347048058738" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)} className="block w-full">
            <button
